...
//        String description = bundle.getString(PACKAGE_NAME + ".description");
        final int thumbnailTop = bundle.getInt(Constant.PACKAGE + ".top");
        final int thumbnailLeft = bundle.getInt(Constant.PACKAGE + ".left");
        final int thumbnailWidth = bundle.getInt(Constant.PACKAGE + ".width");
        final int thumbnailHeight = bundle.getInt(Constant.PACKAGE + ".height");
        mPosition = bundle.getInt(Constant.PACKAGE + ".position");
        
//        mBitmapDrawable = new BitmapDrawable(getResources(), bitmap);
//        mImageView.setImageDrawable(mBitmapDrawable);
        Picasso.with(this).load(TweetsManager.getInstance().getTweetsList().get(mPosition).getUrlStandardResolution()).into(mImageView);
        mTextView.setText("This is the larger picture!");
    ...
    public void runEnterAnimation() {
        final long duration = (long) (ANIM_DURATION * ListController.sAnimatorScale);
...
//        mImageView.getDrawable().setColorFilter(colorizerFilter);
    }
